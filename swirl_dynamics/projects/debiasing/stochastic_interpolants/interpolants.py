...
class Interpolant(Protocol):
  ...
  def __call__(self, t: Array, x_0: Array, x_1: Array) -> Array:
    """Interpolates between x_0 and x_1 at time t.
...
class StochasticInterpolant(Interpolant):
  ...
  def __call__(self, t: Array, x_0: Array, x_1: Array) -> Array:
    return self.calculate_interpolant(t, x_0, x_1)

  def calculate_interpolant(self, t: Array, x_0: Array, x_1: Array) -> Array:
    ...
    """
    return vmap_mult(self.alpha(t), x_0) + vmap_mult(self.beta(t), x_1)

  def calculate_time_derivative_interpolant(
      self, t: Array, x_0: Array, x_1: Array
  ) -> Array:
    ...
    """
    return vmap_mult(self.alpha_dot(t), x_0) + vmap_mult(self.beta_dot(t), x_1)
