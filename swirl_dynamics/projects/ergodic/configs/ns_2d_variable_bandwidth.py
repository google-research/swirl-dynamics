...
def get_config():
  ...
  # config.mmd_bandwidth = (0.2, 0.5, 0.9, 1.3)
  # config.mmd_bandwidth = (0.2, 0.5, 0.9, 1.3, 20., 50., 90., 130.)
  ...
  # to downsample the spatial coordinates to run the measure faster.
...
def sweep(add):
  """Define param sweep."""
  for seed in [1,]:  # for seed in [1, 11, 21]:
                ...
                for measure_dist_lambda in [0.0, 1.0]:
                  for measure_dist_k_lambda in [0.0, 1.0, 10.0, 100.0,]:
                    for mmd_bandwidth in [
                        (0.2, 0.5, 0.9, 1.3),
                        (0.2, 0.5, 0.9, 1.3, 2.0, 5.0, 9.0, 13.0,),
                        (0.2, 0.5, 0.9, 1.3, 2.0, 5.0, 9.0, 13.0, 20.0, 50.0, 90.0, 130.0,),
                        (2.0, 5.0, 9.0, 13.0, 20.0, 50.0, 90.0, 130.0),
                        (20.0, 50.0, 90.0, 130.0),
                    ]:
                      if use_curriculum:
