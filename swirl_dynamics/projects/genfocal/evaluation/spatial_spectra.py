...
r"""A beam pipeline to compute the spatial radial spectral density of variables.
...
python swirl_dynamics/projects/genfocal/evaluation/spatial_spectra.py \
